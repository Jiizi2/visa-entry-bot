(function () {
  ...
  root.constants = Object.freeze({
    ...
    FILE_URI_RE: /^file:\/\//i,
    AUTOFILL_MODE_LABEL: "super cepat",
    SLOW_MODE_ENABLED: false,
    STEP_BEFORE_DELAY_MS: 200,
    STEP_AFTER_DELAY_MS: 250,
    CLICK_SETTLE_DELAY_MS: 400,
    FILL_SETTLE_DELAY_MS: 20,
    DROPDOWN_SETTLE_DELAY_MS: 400,
    UPLOAD_SETTLE_DELAY_MS: 600,
    UPLOAD_AFTER_DELAY_MS: 200,
    WAIT_SETTLE_DELAY_MS: 200,
    WAIT_POLL_INTERVAL_MS: 80,
    PAGE_READY_POLL_INTERVAL_MS: 80,
    PAGE_READY_STABLE_MS: 300,
    HUMAN_DEFAULT_DELAY_MS: 20,
    HUMAN_DEFAULT_JITTER_MS: 20,
    HUMAN_CLICK_DELAY_MS: 200,
    HUMAN_CLICK_JITTER_MS: 150,
    HUMAN_UPLOAD_DELAY_MS: 300,
    HUMAN_UPLOAD_JITTER_MS: 200,
