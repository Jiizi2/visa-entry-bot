...
import { normalizeDurationMs } from "./main-metrics.js";
import { ocrModeLabel } from "./main-ocr.js";
...
export async function setupScanEventBridge({
  ...
  state,
  appendScanLog = noop,
  rememberRecentBatch = noop,
  renderAll = noop,
  scheduleRenderAll = noop,
  loadManifest = noop,
  closeStopScanModal = noop,
}) {
