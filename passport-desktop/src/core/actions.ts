import { PASSPORT_PREVIEW_ZOOM_STEP } from "../features/passport/preview.js";
import { closestFromEventTarget } from "./system.js";
...
export function bindActions({
  ...
  handleOcrModeChange,
  selectPreparedPassport = (itemId: string) => {},
  rotatePreparedPassport = (direction: number) => {},
  flipPreparedPassport = (axis: string) => {},
  changePreparedPreviewZoom = (delta: number) => {},
  ...
  savePassportCrop = () => {},
  handlePassportCropPointerDown = (event: PointerEvent) => {},
  handlePassportCropPointerMove = (event: PointerEvent) => {},
  handlePassportCropPointerUp = (event: PointerEvent) => {},
  handlePassportCropKeydown = (event: KeyboardEvent) => {},
  handlePassportCropZoomInput = (event: Event) => {},
