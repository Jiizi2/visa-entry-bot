const CORE_WORD_OVERRIDES: Record<string, string> = Object.freeze({
  ABRAR: "\u0623\u0628\u0631\u0627\u0631",
  ABDULLAH: "\u0639\u0628\u062f\u0627\u0644\u0644\u0647",
  ABDILLAH: "\u0639\u0628\u062f\u0627\u0644\u0644\u0647",
  AHMAD: "\u0623\u062d\u0645\u062f",
...
const BATCH_WORD_OVERRIDES: Record<string, string> = Object.freeze({
  ABDULLAH: "\u0639\u0628\u062f \u0627\u0644\u0644\u0647",
  ABDUL: "\u0639\u0628\u062f",
...
const MULTI_CHAR_RULES: Record<string, string> = Object.freeze({
  aa: "\u0627",
  ee: "\u064a",
  ii: "\u064a",
  sy: "\u0634",
...
const TOKEN_OVERRIDES: Record<string, string> = Object.freeze({
  AL: "\u0627\u0644",
  BIN: "\u0628\u0646",
  BINT: "\u0628\u0646\u062a",
  BINTI: "\u0628\u0646\u062a",
...
const BASIC_CHAR_MAP: Record<string, string> = Object.freeze({
  b: "\u0628",
  c: "\u0643",
  d: "\u062f",
  f: "\u0641",
...
export function transliterateName(name?: string | null): string {
...
export function transliterateWord(word?: string | null): string {
...
function mapVowel(word: string, index: number, character: string): string {
  if (index === 0) {
...
function apostropheMarker(word: string, index: number): string {
