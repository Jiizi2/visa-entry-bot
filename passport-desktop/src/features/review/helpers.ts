import { escapeHtml, formatConfidence, uniqueValues } from "../../shared/utils.js";
...
export function flattenFlagEntries(node: any, path: string[] = []): any[] {
...
export function flattenConfidenceEntries(node: any, levelNode: any, path: string[] = []): any[] {
